<%@ Page Title="" Language="C#" MasterPageFile="~/user_result.Master" AutoEventWireup="true" CodeBehind="user_eightresult.aspx.cs" Inherits="school.user_eightresult" %>
        ...
        <div>
            <table  class="auto3">
                <tr>
                    ...
                    <td class="auto-style3"><asp:Label ID="LblNum" runat="server" Text="Roll Number/Name" Font-Bold="true" Font-Size="Large"></asp:Label></td>
                    <td></td>
                    <td>
