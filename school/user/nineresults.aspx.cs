...
namespace school
{
    public partial class nineresults : System.Web.UI.Page
    {
        ...
        public void bindData()
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from nineres where rollnumber='" + Lblrollnumber.Text + "' or name='" + Lblrollnumber.Text + "' and exam='" + LblExam.Text + "'", con);
