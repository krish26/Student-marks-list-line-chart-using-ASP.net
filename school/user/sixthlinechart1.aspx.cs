...
{
    public partial class sixthlinechart : System.Web.UI.Page
    {
        ...
        private void Bindchart()
        {
            ...
            {
                SqlCommand cmd1 = new SqlCommand("select * from sixres where rollnumber=@rollnum and exam='mid1'", con);
            ...
            {
                SqlCommand cmd1 = new SqlCommand("select * from sixres where rollnumber=@rollnum and exam='mid2'", con);
                cmd1.Parameters.AddWithValue("rollnum", txtline.Text);
                SqlDataAdapter da = new SqlDataAdapter();
                da.SelectCommand = cmd1;
                DataSet ds = new DataSet();
            ...
            if (Txtexam.Text == "mid3")
            {
                ...
                SqlCommand cmd1 = new SqlCommand("select * from sixres where rollnumber=@rollnum", con);
                cmd1.Parameters.AddWithValue("rollnum", txtline.Text);
                SqlDataAdapter da = new SqlDataAdapter();
                da.SelectCommand = cmd1;
                DataSet ds = new DataSet();
