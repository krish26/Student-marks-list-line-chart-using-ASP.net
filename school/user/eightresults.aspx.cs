...
namespace school
{
    public partial class eightresults : System.Web.UI.Page
    {
        ...
        public void bindData()
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from eightres where rollnumber='" + Lblrollnumber.Text + "' or name='" + Lblrollnumber.Text + "' and exam='" + LblExam.Text + "'", con);
