<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/adminmaster.Master" AutoEventWireup="true" CodeBehind="sixgrid.aspx.cs" Inherits="school.sixgrid" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="auto-style4">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="id" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Width="1300px" CssClass="auto-style3" Height="309px">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:projectConnectionString2 %>" SelectCommand="SELECT * FROM [sixres]" DeleteCommand="DELETE FROM [sixres] WHERE [id] = @id" InsertCommand="INSERT INTO [sixres] ([rollnumber], [name], [section], [telugu], [hindi], [english], [maths], [science], [social], [exam], [total], [createdon]) VALUES (@rollnumber, @name, @section, @telugu, @hindi, @english, @maths, @science, @social, @exam, @total, @createdon)" UpdateCommand="UPDATE [sixres] SET [rollnumber] = @rollnumber, [name] = @name, [section] = @section, [telugu] = @telugu, [hindi] = @hindi, [english] = @english, [maths] = @maths, [science] = @science, [social] = @social, [exam] = @exam, [total] = @total, [createdon] = @createdon WHERE [id] = @id">
        <DeleteParameters>
