<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/adminmaster.Master" AutoEventWireup="true" CodeBehind="seventhgrid.aspx.cs" Inherits="school.seventhgrid" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="text-align: center">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" CellPadding="4" DataKeyNames="id" ForeColor="#333333" GridLines="None" Width="1300px">
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:projectConnectionString4 %>" SelectCommand="SELECT * FROM [sevenres]" DeleteCommand="DELETE FROM [sevenres] WHERE [id] = @id" InsertCommand="INSERT INTO [sevenres] ([rollnumber], [name], [section], [telugu], [hindi], [english], [maths], [science], [social], [exam], [total], [createdon]) VALUES (@rollnumber, @name, @section, @telugu, @hindi, @english, @maths, @science, @social, @exam, @total, @createdon)" UpdateCommand="UPDATE [sevenres] SET [rollnumber] = @rollnumber, [name] = @name, [section] = @section, [telugu] = @telugu, [hindi] = @hindi, [english] = @english, [maths] = @maths, [science] = @science, [social] = @social, [exam] = @exam, [total] = @total, [createdon] = @createdon WHERE [id] = @id">
    <DeleteParameters>
